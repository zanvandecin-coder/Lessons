...
**Установите Node.js (необходимо не ниже v18.14.15):** Рекомендуется использовать NodeSource для получения свежей версии.
...
**Создайте проект Astro:** Запустите мастер установки в папке, где хотите создать сайт:
...
```
user@debian01:~/Рабочий стол/my_site$ npm create astro@latestNeed to install the following packages:create-astro@5.0.5Ok to proceed? (y) y
npm warn EBADENGINE Unsupported engine {npm warn EBADENGINE package: 'create-astro@5.0.5',npm warn EBADENGINE required: { node: '>=22.12.0' },
npm warn EBADENGINE current: { node: 'v20.20.2', npm: '10.8.2' }
npm warn EBADENGINE }> npx> create-astroNode.js v20.20.2 is out-of-date and unsupported!Please use Node.js v22 or higher.
npm error code 1npm error path /home/user/Рабочий стол/my_sitenpm error command failed
npm error command sh -c create-astronpm noticenpm notice New major version of 
npm available! 10.8.2 -> 11.12.1
npm notice Changelog: https://github.com/npm/cli/releases/tag/v11.12.1
npm notice To update run: npm install -g npm@11.12.1npm notice
npm error A complete log of this run can be found in: /home/user/.npm/_logs/2026-04-14T00_57_20_579Z-debug-0.log
user@debian01:~/Рабочий стол/my_site$
```



Похоже, для последней версии Astro теперь требуется **Node.js версии 22.12.0** или выше, а у вас сейчас установлена версия **20.20.2**. 

Поскольку вы используете Debian, самый простой способ решить эту проблему и избежать проблем с правами доступа — использовать **nvm** (менеджер версий Node). Вот как это исправить:
...
*(After running this, restart your terminal or run `source ~/.bashrc`)* 
...
\4. Try creating your project again
...
If you prefer not to use `nvm`, you can update Node via the NodeSource setup scripts, but `nvm` is generally safer for development environments to prevent breaking system-level dependencies.
